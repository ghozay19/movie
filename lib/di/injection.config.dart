...
import '../data/datasources/local/dao/theme_preferences_dao.dart' as _i21;
...
import '../data/datasources/local/theme_datasource.dart' as _i25;
import '../data/datasources/local/theme_datasource_impl.dart' as _i26;
...
import '../domain/usecase/retrieve_theme_prefs.dart' as _i29;
import '../domain/usecase/save_theme_prefs.dart' as _i30;
import '../domain/usecase/store_movie_to_local.dart' as _i20;
import '../presentation/bookmark/store/bookmark_store.dart' as _i22;
import '../presentation/dashboard/store/dashboard_store.dart' as _i5;
import '../presentation/detail/store/detail_movie_store.dart' as _i23;
import '../presentation/home/store/home_store.dart' as _i24;
import '../presentation/router/app_router.dart' as _i4;
import '../presentation/theme/theme_store.dart' as _i31;
import 'network_module.dart' as _i32;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i21.ThemePreferencesDao>(
        () => _i21.ThemePreferencesDao(gh<_i3.AppDatabase>()));
    gh.factory<_i22.BookmarkStore>(
        () => _i22.BookmarkStore(gh<_i16.RetrieveAllLocalMovies>()));
    gh.factory<_i23.DetailMovieStore>(() => _i23.DetailMovieStore(
          gh<_i20.StoreMovieToLocal>(),
          gh<_i15.RemoveLocalMovie>(),
          gh<_i19.RetrieveLocalMovie>(),
        ));
    gh.factory<_i24.HomeStore>(() => _i24.HomeStore(
          gh<_i18.RetrieveGenres>(),
          gh<_i17.RetrieveDiscoveryMovies>(),
        ));
    gh.lazySingleton<_i25.ThemeDatasource>(
        () => _i26.ThemeDatasourceImpl(gh<_i21.ThemePreferencesDao>()));
    gh.lazySingleton<_i27.ThemeRepository>(
        () => _i28.ThemeRepositoryImpl(gh<_i25.ThemeDatasource>()));
    gh.lazySingleton<_i29.RetrieveThemePrefs>(
        () => _i29.RetrieveThemePrefs(gh<_i27.ThemeRepository>()));
    gh.lazySingleton<_i30.SaveThemePrefs>(
        () => _i30.SaveThemePrefs(gh<_i27.ThemeRepository>()));
    gh.factory<_i31.ThemeStore>(() => _i31.ThemeStore(
          gh<_i30.SaveThemePrefs>(),
          gh<_i29.RetrieveThemePrefs>(),
        ));
    return this;
  }
}
